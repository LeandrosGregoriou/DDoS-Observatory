...
--
-- Host: localhost    Database: RecordsDB
-- ------------------------------------------------------
...
CREATE TABLE `recordsTable` (
  ...
  `BGPCommunities` text NOT NULL,
  `nextHop` varchar(45) DEFAULT NULL,
  `collector` varchar(7) DEFAULT NULL,
...
-- Dump completed on 2019-02-14 16:09:46
